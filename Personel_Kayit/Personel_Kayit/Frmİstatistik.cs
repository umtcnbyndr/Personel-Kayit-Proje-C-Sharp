...
namespace Personel_Kayit
{
    public partial class Frmİstatistik : Form
    {
        ...
        private void Frmİstatistik_Load(object sender, EventArgs e)
        {
            ...
            //Şehir Sayısı
            baglanti.Open();
            SqlCommand komut4 = new SqlCommand("select count(*) from Tbl_Personel where Persehir ", baglanti);
            ...
            //Ortalama Maaş
            baglanti.Open();
            SqlCommand komut6 = new SqlCommand("select COUNT(Permaas) from Tbl_Personel", baglanti);
